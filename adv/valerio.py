...
class Valerio(StanceAdv):
    ...
    def prerun(self):
        random.seed()
        self.config_stances({
            'appetizer': ModeManager(self, 'appetizer', x=True, s1=True, s2=True),
            'entree': ModeManager(self, 'entree', x=True, s1=True, s2=True),
            'dessert': ModeManager(self, 'dessert', x=True, s1=True, s2=True),
        }, hit_threshold=20)
