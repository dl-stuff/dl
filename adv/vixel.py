...
class Vixel_70MC(Adv):
    ...
    conf = {
        ...
        "fs_vixel": {
            ...
            "recovery": 1.46667,
            "attr": [
                {"dmg": 0.61, "odmg": 4.2, "sp": 580, "dispel": 100},
                {"dmg": 0.61, "odmg": 4.2, "iv": 0.36667},
                {"dmg": 0.61, "odmg": 4.2, "iv": 0.73333},
                {"dmg": 0.61, "odmg": 4.2, "iv": 0.96667}
            ],
        ...
        "s1": {
            ...
            "recovery": 1.8,
            "attr": [
                {"buff": ["fsAlt", "vixel", -1, 1, "-refresh"], "coei": 1},
        ...
        "s2": {
            ...
            "attr": [
                ...
                {"heal": [72, "team"], "iv": 1.26667},
                {"buff": ["team", 0.1, 10.0, "recovery", "buff"], "coei": 1, "iv": 1.33333},
                {"buff": ["energy", 1, "team"], "iv": 1.33333}
            ],
            "energizable": True
    }
}
