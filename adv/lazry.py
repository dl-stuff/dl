...
class Lazry_70MC(Lazry):
    ...
    conf = {
        ...
        "s1_low": {"sp": 3194, "startup": 0.0, "recovery": 1.7, "attr": [{"dmg": 3.2, "afflic": ["frostbite", 120, 0.41], "iv": 0.6}, {"dmg": 3.2, "iv": 0.8}, {"dmg": 6.0, "iv": 1.43333}]},
        "s2_high": {"sp": 7475, "startup": 0.0, "recovery": 2.5, "attr": [{"dmg": 4.5, "dispel": 100, "iv": 1.66667}, {"dmg": 16.6, "iv": 1.66667}, {"sp": [1.0, "%", "s1"], "iv": 2.4}]},
        "s2_low": {
            "sp": 7475,
            "startup": 0.0,
            "recovery": 1.66667,
